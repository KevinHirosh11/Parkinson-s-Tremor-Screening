...
```
┌─────────────────────────┐          ┌──────────────────────────┐
│   ESP32 Wearable Unit   │          │      Standard Webcam     │
│  (MPU6050 Accel + Gyro) │          │  (Google MediaPipe 21pts)│
└────────────┬────────────┘          └────────────┬─────────────┘
             │ (Serial / WebSocket @ 30Hz)        │ (30 FPS Video Stream)
             ▼                                    ▼
┌───────────────────────────────────────────────────────────────┐
│                    FastAPI Backend Engine                     │
│  • SciPy Butterworth 2nd-order Low-Pass Filter (12 Hz Cutoff) │
│  • Hanning Windowed Fast Fourier Transform (FFT)              │
│  • Multi-Output Random Forest Classifier                      │
│  • Diagnostic PDF Generation (FPDF / ReportLab)               │
└────────────────────────────┬──────────────────────────────────┘
                             │ (WebSocket / HTTP REST API)
                             ▼
┌───────────────────────────────────────────────────────────────┐
│             TremorPlot Desktop GUI (Electron + React)         │
│  • Patient Profile & Motor Protocol Setup                     │
│  • Live Landmark Overlay & Vibration Oscilloscope             │
│  • Dynamic FFT Frequency Spectrum & Clinical Severity Gauges  │
└───────────────────────────────────────────────────────────────┘
```
...
> *Place your screenshots inside `docs/images/` and ensure the filenames match below.*

### 1. TremorPlot Clinical Dashboard
<p align="center">
  <!-- Replace with your actual dashboard screenshot: docs/images/dashboard_preview.png -->
  <img src="docs/images/dashboard_preview.png" alt="TremorPlot Dashboard" width="90%" onerror="this.src='https://placehold.co/1200x650/0b132b/06b6d4?text=Place+Dashboard+Screenshot+Here+(docs/images/dashboard_preview.png)'" />
  <br>
...
<p align="center">
  <!-- Replace with tracking screenshot: docs/images/tracking_feed.png -->
  <img src="docs/images/tracking_feed.png" alt="Hand Tracking and Vibration Analysis" width="90%" onerror="this.src='https://placehold.co/1200x500/0f172a/38bdf8?text=Place+Webcam+Tracking+%2B+Oscilloscope+Screenshot+Here+(docs/images/tracking_feed.png)'" />
  <br>
...
<p align="center">
  <!-- Replace with hardware prototype photo: docs/images/hardware_prototype.png -->
  <img src="docs/images/hardware_prototype.png" alt="ESP32 Wearable Prototype" width="80%" onerror="this.src='https://placehold.co/900x500/1e293b/10b981?text=Place+ESP32+Hardware+Prototype+Photo+Here+(docs/images/hardware_prototype.png)'" />
  <br>
...
```bash
git clone https://github.com/[YOUR-USERNAME]/Parkinson-s-Tremor-Screening.git
...
<p align="center">
  <!-- Replace with workflow illustration: docs/images/workflow_steps.png -->
  <img src="docs/images/workflow_steps.png" alt="Clinical Screening Workflow" width="90%" onerror="this.src='https://placehold.co/1100x250/1e293b/38bdf8?text=Step+1:+Patient+Info+%E2%9E%94+Step+2:+Select+Task+%E2%9E%94+Step+3:+Run+Capture+%E2%9E%94+Step+4:+Export+PDF'" />
</p>
...
## 📑 Diagnostic PDF Report Output

<p align="center">
  <!-- Replace with sample PDF preview: docs/images/pdf_report_sample.png -->
  <img src="docs/images/pdf_report_sample.png" alt="Diagnostic PDF Report Sample" width="60%" onerror="this.src='https://placehold.co/700x950/ffffff/0f172a?text=Place+Diagnostic+PDF+Report+Screenshot+Here+(docs/images/pdf_report_sample.png)'" />
  <br>
  <em>Figure 4: Automated Clinical Diagnostic Report generated by TremorPlot.</em>
</p>

Each exported PDF report contains:
* Standardized Patient Profile (ID, Name, Age, Timestamp, Report ID)
* Extracted Kinematic Metrics (Dominant Peak Frequency, Amplitude RMS)
* Machine Learning Diagnostic Assessment (Severity, Frequency Band, Hoehn & Yahr Staging)
* Integrated Clinical Signal Waveform Chart
* Clinician & Technician Signature Lines with Medical Advisory Disclaimer
...
* **Author / Mentee:** [Kevin Hirosh](https://github.com/[YOUR-USERNAME])
