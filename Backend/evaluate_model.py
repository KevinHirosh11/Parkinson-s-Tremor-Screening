...
def evaluate_saved_model():
    ...
    try:
        ...
        print(f"[Evaluation Warning] Video-based evaluation failed ({e}). Falling back to simulation logic.")
        # Reconstruct the augmented testing set (same preprocessing as run.py fallback)
